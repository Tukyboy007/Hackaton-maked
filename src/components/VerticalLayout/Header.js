          ...
          <div className="d-flex">
            <div className="navbar-brand-box">
              <Link to="/dashboard" className="logo logo-dark">
                ...
                <span className="logo-lg">
                  <img src={logoSvg} alt="" height="24" /> <span className="logo-txt">Uizhen</span>
                </span>
              </Link>
            ...
            <form className="app-search d-none d-lg-block px-5">
              <div className="position-relative" >
                <input type="text" className="form-control" placeholder="Хайх..." />
                <button id="btn1" className="btn btn-primary" type="button"><i className="bx bx-search-alt align-middle"></i></button>
              </div>
            </form>
          </div>
